    ...
    <header className="flex h-14 items-center justify-between border-b border-border bg-card/95 backdrop-blur-sm px-5 z-40 shrink-0">
      ...
      <div className="flex items-center gap-0.5">
        ...
        <Link to="/things-matter">
          <button className="flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-colors" title="Things & Matter">
        ...
        {/* Papan Tugas */}
        <Link to="/board">
          <button className="flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-colors" title="Papan Tugas">
